...
// get employees
// (GET /v1/employees/{employee_id})
func (_ Unimplemented) GetEmployees(w http.ResponseWriter, r *http.Request, employeeId string) {
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/v1/employees/{employee_id}", wrapper.GetEmployees)
	})
	r.Group(func(r chi.Router) {
...
type GetEmployees200JSONResponse struct {
	union json.RawMessage
}
...
type GetEmployees400Response struct {
}

func (response GetEmployees400Response) VisitGetEmployeesResponse(w http.ResponseWriter) error {
	w.WriteHeader(400)
	return nil
}

type GetEmployees500Response struct {
}

func (response GetEmployees500Response) VisitGetEmployeesResponse(w http.ResponseWriter) error {
	w.WriteHeader(500)
	return nil
}
...
// GetEmployees operation middleware
func (sh *strictHandler) GetEmployees(w http.ResponseWriter, r *http.Request, employeeId string) {
